...
var _addPosts = __webpack_require__(174);

var _CreateAndReadPost = __webpack_require__(175);
...
var AllPosts = (function (_React$Component) {
	...
	function AllPosts() {
		...
		_get(Object.getPrototypeOf(AllPosts.prototype), "constructor", this).apply(this, arguments);
	}
	...
	_createClass(AllPosts, [{
		...
		value: function render() {
			return _react2["default"].createElement(
				...
				null,
				">",
				_react2["default"].createElement(_CreateAndReadPost.CreateAndReadPost, null)
			);
		}
	}]);
...
(function () {
	(0, _addPosts.addPosts)('allPosts').then(function () {
		(0, _reactDom.render)(_react2["default"].createElement(AllPosts, null), document.getElementById('content'));
	});
})();
...
// module
exports.push([module.i, "body{\n\tbackground: url(" + __webpack_require__(171) + ") no-repeat;\n\tbackground-size: cover;\n\tfont-family: \"Noto Sans\", Arial, sans-serif;\n}\n\n.content-block{\n\tbackground: #a9a9a9;\n\twidth: 800px;\n\tmargin: auto;\n\tdisplay: flex;\n\t-webkit-justify-content: center;\n\tjustify-content: center;\n\t-webkit-flex-direction: column;\n\tflex-direction: column;\n}\n\n.form-create-post-header{\n\tbackground: #242424;\n\theight: 40px;\n\twidth: 800px;\n}\n\n.form-create-post-form{\n\twidth: inherit;\n\theight: 240px;\n\tdisplay: flex;\n\t-webkit-flex-direction: column;\n\tflex-direction: column;\n\tpadding: 20px 70px 0 70px;\n}\n\n.form-create-post-form__title{\n\tmargin-bottom: 20px;\n}\n\n.form-create-post-form__elm-title{\n\theight: 25px;\n\tmargin-bottom: 10px;\n}\n\n.form-create-post-form__elm-post{\n\theight: 100px;\n\tpadding-top: 5px;\n}\n\n.form-create-post-form__elm-title, .form-create-post-form__elm-post{\n\tborder: 1px solid gray;\n\tpadding-left: 10px;\n}\n\n.form-create-post-form__btn-location{\n\tdisplay: flex;\n\t-webkit-justify-content: flex-end;\n\tjustify-content: flex-end;\n}\n\n.form-create-post-form__btn-create{\n\theight: 29px;\n\twidth: 199px;\n\tmargin-top: 10px;\n\tbackground: #242424;\n\tcolor: white;\n\tborder: none;\n}\n\n.form-create-post-form__btn-create:hover{\n\tbackground: #908484;\n}\n\n\n.form-posts{\n\twidth: inherit;\n\tbackground: white;\n}\n\n\n\n.form-posts__post{\n\tpadding: 14px 70px;\n\tdisplay: flex;\n\t-webkit-flex-direction: column;\n\tflex-direction: column;\n\tbackground: white;\n}\n\n.form-posts__post--gray{\n\tbackground: #c4c4c4;\n}\n\n.form-posts__post:hover{\n\tbackground: #808080;\n}\n\n.form-posts__post--title,\n.form-posts__detail-post--title{\n\tmargin-bottom: 25px;\n\tfont-size: 25px;\n\tcolor: black;\n\ttext-decoration: none;\n}\n\n.form-posts__detail-post{\n\tpadding: 14px 70px;\n\tdisplay: flex;\n\t-webkit-flex-direction: column;\n\tflex-direction: column;\n\tbackground: white;\n}\n\n.form-posts__detail-post__btnBack-position{\n\tmargin: 20px 0;\n}\n\n.form-posts__detail-post--back{\n\tcolor: white;\n\tbackground: black;\n\tpadding: 10px;\n\ttext-decoration: none;\n}", ""]);
...
module.exports = __webpack_require__.p + "839ca50cc40197c9d9f70fe8cd4ec11d.jpg";
...
var getData = function getData(storageKey) {
...
var addPosts = function addPosts(data) {
	if (!localStorage.getItem(data)) {
		return load('../posts.json').then(function (text) {
...
var _posts = __webpack_require__(176);

var _detailedPost = __webpack_require__(177);

var CreateAndReadPost = (function (_React$Component) {
	_inherits(CreateAndReadPost, _React$Component);

	function CreateAndReadPost() {
		_classCallCheck(this, CreateAndReadPost);

		_get(Object.getPrototypeOf(CreateAndReadPost.prototype), "constructor", this).call(this);
		this.state = {
	...
	_createClass(CreateAndReadPost, [{
		key: "refreshPost",
		value: function refreshPost() {
			this.setState({ posts: JSON.parse(localStorage.getItem('allPosts')) });
		}
	}, {
		key: "showDetailedPost",
		value: function showDetailedPost(id) {
			event.stopPropagation();
			this.setState({
				detailed: true,
				idPost: id
		...
		key: "smalledText",
		value: function smalledText() {
			var post = this.state.posts;
			var smallPost = [];
			function smalled(currentPost) {
				var textCurrentPost = currentPost.text;
				if (textCurrentPost.length > 300) {
					var indexSpace = textCurrentPost.indexOf(' ', 301);
					var text = textCurrentPost.substring(0, indexSpace) + ' ...';
					currentPost.text = text;
				}
				smallPost.push(currentPost);
			}

			post.forEach(function (currentPost) {
				smalled(currentPost);
			});
			return smallPost;
		}
		...
		key: "currentPost",
		value: function currentPost(id) {
			var post = JSON.parse(localStorage.getItem('allPosts'));
			return post[id];
		}
	}, {
		key: "render",
		value: function render() {
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement("div", { className: "form-create-post-header" }),
				this.state.detailed ? _react2["default"].createElement(_detailedPost.DetailedPost, { detailedPost: this.currentPost(this.state.idPost),
					allPosts: function () {
						return _this.allPosts();
					} }) : _react2["default"].createElement(_posts.Posts, { smallPosts: this.smalledText(),
					showDetailedPost: function (id) {
						return _this.showDetailedPost(id);
					},
					refreshPost: function () {
						return _this.refreshPost();
					} })
			);
		}
	}]);

	return CreateAndReadPost;
})(_react2["default"].Component);

exports.CreateAndReadPost = CreateAndReadPost;
...
var Posts = (function (_React$Component) {
	...
	function Posts() {
		...
		_get(Object.getPrototypeOf(Posts.prototype), 'constructor', this).apply(this, arguments);
	}

	_createClass(Posts, [{
		key: 'postInStorage',
		value: function postInStorage(post) {
			localStorage.setItem('allPosts', JSON.stringify(post));
		}
	}, {
		key: 'checkField',
		value: function checkField(title, post) {
			if (title && post) {
				if (title.value.length && post.value.length) {
					return true;
				} else {
					var alertTitleField = 'Заполните поле Название',
					    alertTextField = 'Заполните поле Содержание';
					!title.value.length ? alert(alertTitleField) : !post.value.length ? alert(alertTextField) : '';
				}
			}
			return false;
		}
		...
		value: function addPost() {
			...
			var textPost = document.getElementById('post');
			var allPost = JSON.parse(localStorage.getItem('allPosts'));
			var idPost = allPost.length;
		...
		value: function render() {
			...
			var smallPosts = _props.smallPosts;
			var showDetailedPost = _props.showDetailedPost;
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'span',
							{ className: 'form-create-post-form__title' },
							'Форма создания поста'
						),
						_react2['default'].createElement('input', { className: 'form-create-post-form__elm-title', type: 'text', placeholder: 'Название поста', id: 'title' }),
						_react2['default'].createElement('textarea', { className: 'form-create-post-form__elm-post', type: 'text', placeholder: 'Содержание поста', id: 'post' }),
						_react2['default'].createElement(
							'div',
							{ className: 'form-create-post-form__btn-location' },
							_react2['default'].createElement(
								'button',
								{ className: 'form-create-post-form__btn-create', onClick: function () {
										return _this.addPost();
									} },
								'Создать пост'
							)
						)
				...
				_react2['default'].createElement(
					...
					smallPosts.map(function (post) {
						return _react2['default'].createElement(
							...
							_react2['default'].createElement(
								'a',
								{ href: "#", className: 'form-posts__post--title', onClick: function () {
										return showDetailedPost(post.id);
									} },
								post.title
							),
							_react2['default'].createElement(
...
var DetailedPost = (function (_React$Component) {
	...
	function DetailedPost() {
		...
		_get(Object.getPrototypeOf(DetailedPost.prototype), 'constructor', this).apply(this, arguments);
	}
	...
	_createClass(DetailedPost, [{
		...
		value: function render() {
			var _props = this.props;
			var detailedPost = _props.detailedPost;
			var allPosts = _props.allPosts;

			return _react2['default'].createElement(
				'div',
				{ className: 'form-posts__detail-post' },
				_react2['default'].createElement(
					'div',
					{ className: 'form-posts__detail-post__btnBack-position' },
					_react2['default'].createElement(
						'a',
						{ href: '#', className: 'form-posts__detail-post--back', onClick: function () {
								return allPosts();
							} },
						'Назад'
					)
				...
				_react2['default'].createElement(
					'span',
					{ className: 'form-posts__detail-post--title' },
					detailedPost.title
				),
				_react2['default'].createElement(
					'span',
...
exports.DetailedPost = DetailedPost;
